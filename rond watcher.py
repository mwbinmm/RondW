...
rond_watcher.py
----------------
برای هر کد از پیش‌شماره‌ی 0912 (یعنی 09120 تا 09129)، صفحه‌ی مربوطه رو در
سایت rond.ir چک می‌کنه و شماره‌هایی که قیمتشون زیر سقفِ مخصوصِ همون کد
باشه رو پیدا می‌کنه. فقط شماره‌های "جدید" (که قبلاً اطلاع داده نشدن) با
ربات تلگرام فرستاده می‌شن.

تنظیمات (سقف قیمت هر کد) پایین همین فایل، بخش CONFIG.
"""
...
# سقف قیمت به تومان، برای هر کد از 0912.
CODE_PRICE_CEILINGS = {
    "0": 60_000_000,
    "1": 430_000_000,
    "2": 220_000_000,
